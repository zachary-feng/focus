...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private void updateAG() {
        ...
        elem1.setText(String.format("%6.2f", alphaBuffer[0] - gammaBuffer[0]));
        TextView elem2 = (TextView)findViewById(R.id.elem2);
        elem2.setText(String.format("%6.2f", alphaBuffer[1] - gammaBuffer[1]));
        TextView elem3 = (TextView)findViewById(R.id.elem3);
        elem3.setText(String.format("%6.2f", alphaBuffer[2] - gammaBuffer[2]));
        TextView elem4 = (TextView)findViewById(R.id.elem4);
        elem4.setText(String.format("%6.2f", alphaBuffer[3] - gammaBuffer[3]));
        TextView elem5 = (TextView)findViewById(R.id.elem5);
        elem5.setText(String.format("%6.2f",
                (alphaBuffer[0] + alphaBuffer[1] + alphaBuffer[2] + alphaBuffer[3])
                - (gammaBuffer[0] + gammaBuffer[1] + gammaBuffer[2] + gammaBuffer[3])
        ));
    }
